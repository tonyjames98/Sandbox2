...
## Testing
The application includes a comprehensive integration test suite (`simple-tests.js`) that verifies over 2,000 financial scenarios. To run tests, open `simple-test-runner.html` in your browser.
